...
export default function Contactus() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post("http://localhost:4001/contact/contactus", contactInfo)
      .then((res) => {
  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-blue-900 sm:text-5xl">Contact sales</h2>
